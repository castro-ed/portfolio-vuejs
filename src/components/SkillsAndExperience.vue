    ...
    <section class="text-white mt-18" id="skills">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 xl:px-16">
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-[80%]">
                <h2 class="text-4xl font-bold text-white text-left mb-4">MINHAS
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-secundary to-primary">HABILIDADES</span>
                </h2>
            ...
            <div data-aos="flip-left">
                <h2 class="text-4xl font-bold text-white text-left mb-8 md:text-center md:mt-0 mt-8">MINHAS <span class="text-transparent bg-clip-text bg-gradient-to-r from-secundary to-primary">EXPERIÊNCIAS</span></h2>
                <div class="space-y-8 py-8" data-aos="fade-left">
                    ...
                    <div class="w-3/4 pl-4">
                        <h3 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-secundary to-primary">
                            {{ element.role }}
                        </h3>
...
const Skills =ref([
    {
        id:1,
        name:'JavaScript: VueJS; ReactJS; Angular; Node; NestJS.',
        width:'85%'
    },
    {
        id:2,
...
const Experinces =ref([
    {
        id:1,
        role:'BUSCANDO MINHA PRIMEIRA OPORTUNIDADE',
        company:'Espero que em sua empresa 😁​',
        date:'Mar 2023 - September 2024'
    },
    {
        id:2,
        role:'PROFESSOR DE INGLÊS',
        company:'Escolas em Goiânia',
        date:'Mar 2018 - Jan 2024'
    },
])
</script>