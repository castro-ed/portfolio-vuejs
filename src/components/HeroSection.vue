            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Olá, me chamo <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secundary">Edison Castro</span>​👨‍💻​
                        </h1>
                    </div>

                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Meu nome é Edison Castro, tenho 23 anos e sou desenvolvedor web full-stack júnior com paixão por tecnologia e inovação. 
                        Estudante de Engenharia de Software e Gestão da Informação pela UFG, busco combinar conhecimento técnico e estratégico para criar soluções digitais eficientes. 
                        Com experiência em desenvolvimento front-end e back-end, estou sempre em busca de aprendizado, desafios e oportunidades para transformar ideias em resultados reais por meio da programação.
                    </p>
                    ...
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <button class="px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <span class="relative flex items-center justify-center text-white">Me contrate! ​👉​​</span>
                        </button>
                        ...
                        <button class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <div class="svg-container">
                                ...
                                <a href="src\assets\resume.pdf" download="resume.pdf" class="pl-2 text-primary ">Meu currículo 📑​</a>
                            </div>
                        </button>
                    </div>
                </div>
                ...
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        opacity-25 from-[#570cac] to-primary blur-2xl"></div>
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rouded-full
                        shadow-lg border-primary">
                            <img src="@/assets/pic.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
