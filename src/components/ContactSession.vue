<template>
    <section class="text-white mt-20" id="contato">
        <h2 class="text-4xl font-bold text-white text-left mb-4 px-4 xl:pl-16">Vamos conversar?</h2>
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Entre em contato comigo! Estou disponível para debatermos seus projetos e ideias!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>Email</h4>
                            <p>edisoncastro.dsc@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                    ...
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                            style="background: #111a3e; width: 50px;height: 46px; display: flex;justify-content: center; border-radius: 50%;
                        overflow: hidden;border: 1px solid#111a3e;backdrop-filter: blur(9px);-webkit-backdrop-filter: blur(9px);">
                            <a href="https://www.linkedin.com/in/edisoncastro-/" target="_blank"><img src="https://img.icons8.com/ios-filled/50/ffffff/linkedin.png" alt="linkedin"
                                class="w-6"></a>
                        </div>
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>https://www.linkedin.com/in/edisoncastro-/</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                ...
                <div class="mb-6">
                    ...
                    placeholder="Entre em contato!" name="Message"></textarea>
                </div>
                <button class="z-1 w-[100%!important] hover:bg-secundary  px-6 md:px-7 py-3 rounded-full sm:w-max flex justify-center text-white bg-primary border-2 border-transparent">
                    Enviar e-mail
                </button>
            </form>
        </div>
